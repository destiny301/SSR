...
class TileSelection(nn.Module):
    ...
    def __init__(self, args, num_cls) -> None:
        ...
        self.fea_mlp3 = Mlp(in_features=96*(2**self.num_layers), hidden_features=96*(2**self.num_layers), out_features=96*(2**self.num_layers))
        ...
        self.fea_mlp2 = Mlp(in_features=96*(2**(self.num_layers-1)), hidden_features=96*(2**self.num_layers), out_features=96*(2**self.num_layers))
        ...
        self.fea_mlp1 = Mlp(in_features=96*(2**(self.num_layers-2)), hidden_features=96*(2**self.num_layers), out_features=96*(2**self.num_layers))
